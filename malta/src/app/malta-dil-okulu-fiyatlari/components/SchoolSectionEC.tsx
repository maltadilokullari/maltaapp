...
const LOGO_PATH = '/malta-dil-okullari-karsilastirma/ec-malta.png';
const EXTERIOR_IMAGE_PATH = '/malta-dil-okullari-dis/ec-malta-dil-okulu-st-julians.webp';

// Tablo verileri
const priceData = [
  {
    accommodation: 'Öğrenci Apt. (2 Kişi)',
    weeks4: 1749,
    weeks6: 2641,
    weeks8: 3460,
    weeks12: 4773,
  ...
  {
    accommodation: 'Öğrenci Apt. (1 Kişi)',
    weeks4: 2294,
    weeks6: 3391,
    weeks8: 4488,
    weeks12: 6337,
...
export default function SchoolSectionEC() {
  const priceRange = calculatePriceRange(priceData);
  return (
    <section aria-label="EC Malta fiyatları 2026" className="bg-slate-50">
      <div className="mx-auto max-w-6xl px-4 py-8 md:px-8 lg:py-10">
        ...
        >
          <header className="mb-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-semibold text-slate-900" itemProp="name">
                EC Malta Dil Okulu 2026 Güncel Fiyatları (Konaklama Tiplerine Göre)
              </h2>
            </div>
            {priceRange && (
              <p className="mb-4 text-base font-medium leading-relaxed text-slate-900 speakable-ec-fiyat-araligi">
                2026 yılında <strong>EC Malta</strong> paket fiyatları {priceRange.minLabel} için <strong>{priceRange.minPrice.toLocaleString('tr-TR')}€</strong>'dan başlayıp, {priceRange.maxLabel} için <strong>{priceRange.maxPrice.toLocaleString('tr-TR')}€</strong>'a kadar çıkabilir.
              </p>
            )}
            <div className="space-y-2 text-base leading-relaxed text-slate-700">
              <p>
                EC Malta, Malta'nın en büyük ve en çok tercih edilen dil okullarından biridir. 2026 yılı EC Malta dil okulu fiyatları, konaklama tipi ve eğitim süresine göre değişiklik göstermektedir.
              </p>
              <p>
                2026 yılı için EC Malta fiyatları, konaklama tipine ve eğitim süresine göre değişiklik göstermektedir. Aşağıdaki tabloda tüm konaklama seçenekleri ve süre bazlı fiyatları detaylı şekilde görebilirsiniz. <Link href="/malta-dil-okullari/ec-malta" className="font-semibold text-slate-900 hover:underline">EC Malta'nın eğitim programları, sınıf yapısı ve okul özellikleri</Link> hakkında detaylı bilgilere okul sayfasından ulaşabilirsin.
              </p>
            </div>
          </header>
          ...
          <div className="grid grid-cols-1 gap-6 mb-8 lg:grid-cols-2">
            ...
            <div className="relative w-full overflow-hidden rounded-xl border border-slate-200 bg-white shadow-md">
              <div className="aspect-[4/3] relative">
                <Image
                  ...
                  alt="EC Malta dil okulu dış görünüm - St. Julian's bölgesi"
                  fill
            ...
            <div className="rounded-lg border border-slate-200 bg-slate-50 p-6">
              <h3 className="text-lg font-semibold text-slate-900 mb-4">
                EC Malta Fiyatı En Çok Etkileyen Faktörler (2026)
              </h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      Öğrenci apartı, aile yanı ve studio daire seçenekleri arasında fiyat farkı bulunmaktadır.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  <span className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-slate-900" />
                  <div>
                    <span className="text-sm font-semibold text-slate-900">Yüksek sezon farkı</span>
                    <p className="text-sm text-slate-600">
                      6 ay altı programlar için yüksek sezon döneminde ek ücret uygulanır.
                    </p>
                  </div>
                </li>
              </ul>
          ...
          <div className="mb-6">
            <p className="text-base leading-relaxed text-slate-700 speakable-ec-fiyat-aciklama">
              EC Malta dil okulu fiyatları 2026, seçilen konaklama türü ve eğitim süresine bağlı olarak belirlenir. Aşağıdaki tabloda, EC Malta için <strong>haftalık her şey dahil paket fiyatlarını</strong> konaklama tiplerine göre detaylı şekilde inceleyebilirsin.
            </p>
          </div>
          ...
          <div className="mb-6 hidden md:block overflow-x-auto">
            <table className="w-full" itemScope itemType="https://schema.org/Table">
              <caption className="sr-only">
                EC Malta 2026 her şey dahil haftalık paket fiyatları (konaklama tiplerine göre).
              </caption>
              <thead>
          ...
          <p className="mb-6 text-sm leading-relaxed text-slate-600">
            Yukarıdaki fiyatlar, EC Malta için 2026 yılı her şey dahil paket ücretlerini göstermektedir.
          </p>

          {/* Bilgi Kutusu */}
          <div className="mb-6 rounded-xl border border-slate-200 bg-slate-50 p-4 md:p-5 speakable-ec-bilgiler">
            <h3 className="mb-4 text-lg font-semibold text-slate-900" id="ec-malta-bilgiler">
              EC Malta 2026 Fiyatlarına Dair Bilinmesi Gerekenler
            </h3>
            <ul className="space-y-2 text-sm leading-relaxed text-slate-700">
              <li className="flex items-start gap-3">
                <span className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-slate-900" />
                <span>
                  <strong>6 ay</strong> ve üzeri eğitimlerde, yaz dönemi için ek yüksek sezon ücreti alınmaz.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-slate-900" />
                <span>
                  <strong>28.06.2026 – 28.10.2026</strong> tarihleri arasında, 6 ay altı programlarda haftalık <strong>95€</strong> yüksek sezon farkı uygulanır.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-slate-900" />
                <span>
                  Özel banyolu oda tercihinde haftalık <strong>50€</strong> fiyat farkı bulunur.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-slate-900" />
                <span>
                  Tek kişilik oda tercihi için haftalık <strong>125€</strong> ek ücret uygulanır.
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <Link
              ...
              aria-label="EC Malta dil okulu detay sayfası"
            >
              EC Malta İncele
            </Link>
            <a
              href="https://wa.me/35699143066?text=Merhaba,%20EC%20Malta%20dil%20okulu%20fiyatları%20hakkında%20bilgi%20almak%20istiyorum."
              target="_blank"
              rel="noopener noreferrer"
              aria-label="EC Malta dil okulu fiyatları hakkında WhatsApp ile bilgi al"
            ...
            >
              EC Malta Dil Okulu Fiyatını Netleştir
            </a>
          </div>
        </article>
      </div>
