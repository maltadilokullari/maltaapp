  ...
  return (
    <>
      <main className="pt-20">
          ...
          <div className="mx-auto max-w-6xl px-6 py-16 lg:py-20">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
              ...
              <div>
                ...
                <p className="mt-4 text-base leading-relaxed text-slate-700 sm:text-lg speakable-yaz-hero">
        ...
        {/* TOC Section */}
        <section id="icindekiler" className="bg-white border-b border-slate-200">
          <div className="mx-auto max-w-6xl px-6 py-8">
            <nav aria-label="İçindekiler">
              <h2 className="text-xl font-semibold text-slate-900 mb-4 sm:text-2xl">
                İçindekiler
              </h2>
              <ul className="space-y-2 text-sm sm:text-base">
                <li>
                  <a href="#hero" className="text-slate-700 hover:text-slate-900 hover:underline">
                    1. Malta Yaz Okulları 2026
                  </a>
                </li>
                <li>
                  <a href="#yaz-okulu-nedir" className="text-slate-700 hover:text-slate-900 hover:underline">
                    2. Malta Yaz Okulları Nedir?
                  </a>
                </li>
                <li>
                  <a href="#pakete-dahil" className="text-slate-700 hover:text-slate-900 hover:underline">
                    3. Malta Yaz Okulları Paketine Neler Dahil?
                  </a>
                </li>
                <li>
                  <a href="#program-sunan-okullar" className="text-slate-700 hover:text-slate-900 hover:underline">
                    4. Malta Yaz Okulları 2026 – Program Sunan Okullar
                  </a>
                </li>
                <li>
                  <a href="#gunluk-program" className="text-slate-700 hover:text-slate-900 hover:underline">
                    5. Malta Yaz Okullarında Günlük Program
                  </a>
                </li>
                <li>
                  <a href="#aktiviteler-geziler" className="text-slate-700 hover:text-slate-900 hover:underline">
                    6. Malta Yaz Okullarında Aktiviteler ve Geziler
                  </a>
                </li>
                <li>
                  <a href="#konaklama-secenekleri" className="text-slate-700 hover:text-slate-900 hover:underline">
                    7. Malta Yaz Okullarında Konaklama Seçenekleri
                  </a>
                </li>
                <li>
                  <a href="#basvuru-vize" className="text-slate-700 hover:text-slate-900 hover:underline">
                    8. Malta Yaz Okullarına Başvuru ve Vize Süreci
                  </a>
                </li>
                <li>
                  <a href="#sss" className="text-slate-700 hover:text-slate-900 hover:underline">
                    9. Malta Yaz Okulları Hakkında Sık Sorulan Sorular
                  </a>
                </li>
                <li>
                  <a href="#icerik-hakkinda" className="text-slate-700 hover:text-slate-900 hover:underline">
                    10. Bu İçerik Hakkında
                  </a>
                </li>
              </ul>
            </nav>
        ...
        {/* E-E-A-T Kutusu */}
        <section id="icerik-hakkinda" className="bg-white">
          <div className="mx-auto max-w-6xl px-6 py-16">
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-6">
              ...
              <div className="space-y-3 text-sm leading-relaxed text-slate-700">
                <p>
                  Bu sayfadaki incelemeler, Malta'da 7 yıl yaşamış ve okullarda eğitim almış ekibin saha deneyimine dayanır. 10+ okul ziyareti, öğrenci geri bildirimleri ve okul görüşmeleri dikkate alınmıştır.
                </p>
                {lastUpdated && (() => {
                  const now = new Date();
                  const istanbulDate = new Date(now.toLocaleString('en-US', { timeZone: 'Europe/Istanbul' }));
                  ...
                  return (
                    <p className="text-xs text-slate-600">
                      Son güncelleme: <time dateTime={dateTime}>{lastUpdated}</time>
                    </p>
                  );
                })()}
              </div>
